...
mod backend {
    ...
    impl AudioManager {
        ...
        pub fn play_bgm(&mut self, _name: &str, _loop_flag: bool, _fade_in_ms: i32) {}
        pub fn stop_bgm(&mut self, _fade_out_ms: i32) {}
        pub fn play_se(&mut self, _name: &str) {}
        pub fn stop_se(&mut self) {}
        pub fn play_pcmch(&mut self, _ch: i32, _name: &str, _loop_flag: bool) {}
        pub fn stop_pcmch(&mut self, _ch: i32) {}
    }
}
