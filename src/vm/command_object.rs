    ...
    pub(super) fn try_command_object_list(
        ...
        if element[0] == crate::elm::ELM_ARRAY {
            ...
            if element.len() >= 2 {
                ...
                return self.try_command_object(list_id, obj_idx, rest, arg_list_id, args, ret_form, host);
            }
        ...
        match element[0] {
            ELM_OBJECTLIST_RESIZE => {
                ...
                host.on_object_action(list_id, -1, element[0], args);
                true
            }
    ...
    fn try_command_object(
        ...
        match sub {
            ...
            | ELM_OBJECT_LIGHT_NO | ELM_OBJECT_FOG_USE => {
                if arg_list_id == 0 {
                    self.stack.push_int(host.on_object_get(list_id, obj_idx, sub));
                } else {
                    host.on_object_property(list_id, obj_idx, sub, Self::int_arg(args, 0));
                }
                true
            }
            ...
            ELM_OBJECT_SET_POS => {
                ...
                host.on_object_action(list_id, obj_idx, sub, args);
                true
            }
            ...
            ELM_OBJECT_EMOTE_KOE_CHARA_NO | ELM_OBJECT_EMOTE_MOUTH_VOLUME => {
                if arg_list_id == 0 {
                    self.stack.push_int(host.on_object_get(list_id, obj_idx, sub)); // get
                } else {
                    host.on_object_property(list_id, obj_idx, sub, Self::int_arg(args, 0));
                }
                true
            ...
            // =============================================================
            ELM_OBJECT_CHILD => {
                self.try_command_object_list(list_id, &element[1..], arg_list_id, args, ret_form, host)
            }
